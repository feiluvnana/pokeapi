...
class Rest {
  ...
  Future<T> get<T>(Uri uri, T Function(Map<String, dynamic> json) fromJson) async {
    print("Request: $uri");
  ...
  Future<NamedApiResourceList> named(NamedResourceEndpoint endpoint, {int? limit, int? offset}) async {
  ...
  Future<NamedApiResourceList> unnamed(UnnamedResourceEndpoint endpoint, {int? limit, int? offset}) async {
