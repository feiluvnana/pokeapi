...
GrowthRate _$GrowthRateFromJson(Map<String, dynamic> json) => GrowthRate(
  ...
  levels: (json['levels'] as List<dynamic>)
      .map((e) => GrowthRateExperience.fromJson(e as Map<String, dynamic>))
      .toList(),
...
GrowthRateExperience _$GrowthRateExperienceFromJson(
  Map<String, dynamic> json,
) => GrowthRateExperience(
  level: (json['level'] as num).toInt(),
  experience: (json['experience'] as num).toInt(),
);

Map<String, dynamic> _$GrowthRateExperienceToJson(
  GrowthRateExperience instance,
) => <String, dynamic>{
